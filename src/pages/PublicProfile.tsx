                ...
                <div className="px-10 pb-10 pt-12">
                    <div className="relative mb-12 flex flex-col md:flex-row md:items-end justify-between gap-10">
                        <div className="flex items-end gap-8">
                            ...
                            <div className="mb-2 space-y-2">
                                ...
                                <p className="text-slate-500 font-bold text-sm uppercase tracking-widest font-mono">{user.profile.title}</p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 border-t border-slate-800/50 pt-12">
                        <div className="lg:col-span-2 space-y-16">
                            <div>
                                <h3 className="text-[10px] font-bold text-slate-600 uppercase tracking-[0.3em] font-mono mb-6">Profile Summary</h3>
                            ...
                            <div>
                                <h3 className="text-[10px] font-bold text-slate-600 uppercase tracking-[0.3em] font-mono mb-10">Experience Timeline</h3>
                                <div className="space-y-12">
                                    {user.experiences.map(exp => (
                                        <div key={exp.id} className="relative pl-8 border-l border-slate-800 group">
                                            <div className="absolute top-0 left-0 -translate-x-[4.5px] w-2 h-2 rounded-full bg-slate-900 border border-sky-700 group-hover:bg-sky-500 group-hover:border-sky-500 transition-colors"></div>
                            ...
                            <div className="bg-slate-900/40 p-8 rounded border border-slate-800/80 space-y-8 shadow-inner">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4 text-slate-400 font-bold text-xs font-mono">
                                        ...
                                        <span>Location: {user.profile.location}</span>
                                    </div>
                                    <div className="flex items-center gap-4 text-slate-400 font-bold text-xs font-mono">
                                        <div className="w-10 h-10 rounded bg-slate-800 flex items-center justify-center text-sky-600 border border-slate-700/50">
                                            <Briefcase size={18} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pt-8">
                <div className="lg:col-span-2 space-y-8">
                    <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
                        ...
                        <h2 className="text-xl font-black text-white tracking-tighter uppercase font-mono">Skills Matrix</h2>
                    </div>
                ...
                <div className="lg:col-span-1 space-y-8">
                    <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
                        <Terminal size={18} className="text-sky-600" />
                        <h2 className="text-xl font-black text-white tracking-tighter uppercase font-mono">Proficiency Map</h2>
                    </div>
